...
const AccountStats = ({ accountData }: Props) => {
  ...
  const sortFunctions = {
    [SortType.Default]: (a: AccountSkill, b: AccountSkill) =>
      selectSortDirection === SortDirection.DESC ? b.id - a.id : a.id - b.id,
    ...
    [SortType.XP]: (a: AccountSkill, b: AccountSkill) =>
      selectSortDirection === SortDirection.DESC ? b.xp - a.xp : a.xp - b.xp,
  };
        ...
        {skills.map((skill) => {
          return (
            <div className="account-stats__stat">
              <img
                src={icons[skill.skillName.toLowerCase() + "Icon"]}
              ...
              <div className="account-stats__stat__level">
                ...
                <div className="account-stats__stat__level__value">
                  {skill.level} / <span>{skill.maxSkillLevel}</span>
                </div>
              </div>
            </div>
          );
